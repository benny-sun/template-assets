...
(function ($) {
    $.fn.extend({
        ...
        socialProfiles: function (options) {
            ...
            if (options.youtube) {
                listItem += '<li><a href="http://youtube.com/channel/' + options.youtube + '" target="_blank" rel="nofollow" class="aYouTube"><span></span></a><span>YouTube</span></li>';
            }
            ...
            if (options.weibo) {
                listItem += '<li><a href="http://www.weibo.com/u/' + options.weibo + '" target="_blank" rel="nofollow" class="aWeibo"><span></span></a><span>Weibo</span></li>';
            }
            ...
            return this.each(function () {
                ...
                $( document ).on("click", ".arthrefSocialProfiles .overlay:not(ul li)", function (e) {
                    destroyContainer(o, body, overlay, ulElement);
                });

                $( document ).on( "keydown", function( e ) {
                    if( e.keyCode == 27 ) destroyContainer(o, body, overlay, ulElement);
                });
